                                    ...
                                    <form action="../views/confirm.php" method="get">
                                        <div class="form-row">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input type="date" id="check_in" name="check_in" class="form-control p-4" required="required">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="check_out">Check out (~10:00):</label>
                                                <input type="date" id="check_out" name="check_out" class="form-control p-4" required="required">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-lg-2">
                                                ...
                                                <input type="number" id="number_of_people" name="number_of_people" value="1" min="1" class="form-control p-4" required="required">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-lg-6 mx-auto">
                                                <input type="submit" value="CALCULATE" name="calculate" class="btn btn-darkcyan form-control">
                                            </div>
                                        </div>
                                    </form>
                                </div>
