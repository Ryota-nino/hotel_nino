            ...
            <div class="icon-box icon-box-color">
              ...
              <div class="container w-75">
                <form action="../action/userAction.php" method="post">
                  ...
                  <div class="form-row">
                    <div class="form-group col-lg-6">
                      <input type="text" name="phone_number" class="form-control p-4" placeholder="PHONE NUMBER">
                    </div>
                    <div class="form-group col-lg-6">
                      <input type="text" name="card_number" class="form-control p-4" placeholder="CARD NUMBER">
                    </div>
                  </div>
                  <div class="form-row">
