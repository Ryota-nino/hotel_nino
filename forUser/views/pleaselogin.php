...
<body>
    ...
    <main id="main">
        ...
        <section class="please-login section-bg" data-aos="fade-up">
            <div class="container">

                <div class="section-title">
                    <h2>Please Login</h2>
                    <p>If you don't log in, you will not be able to use the reservation function.</p>
                </div>
                <div class="container w-25">
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                            <input type="button" onclick="location.href='login.php'" value="LOGIN" class="btn btn-darkcyan form-control">
                        </div>
                        <div class="form-group col-lg-6">
                            <input type="button" onclick="location.href='signup.php'" value="SIGN UP" class="btn btn-darkcyan form-control">
                        </div>
                    </div>
                </div>
            </div>
        </section><!-- End Please Login Section -->
