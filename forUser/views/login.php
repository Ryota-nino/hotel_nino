              ...
              <form action="../action/userAction.php" method="post">
                <div class="form-row">
                  <div class="form-group col-lg-10 mx-auto">
                    <input type="email" name="email" class="form-control p-4" placeholder="USER ID(E-MAIL)">
                  </div>
                  ...
                  <div class="form-group col-lg-6 mx-auto">
                    <input type="submit" value="LOGIN" name="login" class="btn btn-darkcyan form-control">
                  </div>
                </div>
              </form>
              <p class="description">Don't have your account? <a href="signup.php">Sign up for free</a> now!</p>
              <p class="description"><a href="#">Forget your password?</a></p>
            </div>
          </div>
        </div>
