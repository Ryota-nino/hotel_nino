      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="../assets/img/service-details-1.jpg" alt="..." height="350px" width="100%" style="object-fit: cover;">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Private space</a></h5>
                <p class="card-text">We privide you a unrealistic space. You won't be able to forget time spend at hotel and you will want to come again. If you want to reserve room, you can chose reserve page on the navigation manu.</p>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="../assets/img/service-details-2.jpg" alt="..." height="350px" width="100%" style="object-fit: cover;">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Special Spa</a></h5>
                <p class="card-text">You are looking for special spa. If you want to take special spa, please reserve when you check in at the hotel.</p>
                <div class="read-more"><a href="#"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="../assets/img/service-details-3.jpg" alt="..." height="350px" width="100%" style="object-fit: cover;">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Diving</a></h5>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="../assets/img/service-details-4.jpg" alt="..." height="350px" width="100%" style="object-fit: cover;">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Honeymoon</a></h5>
